...
public class Matricula{
    ...
    /*
        ...
        {
        System.out.println("Dados da matricula");
        System.out.println( listaNome.get(cont) +"||"+  listaCodigoAluno.get(cont) +"||" +   listaCurso.get(cont));
        }
...
public void cadastrarAlunos(){                   
            ...
            PrintWriter gravarArquivo = new PrintWriter(arquivo);
                        ...
                        System.out.println("Agora digite o codigo do aluno,\n");
                        aluno.setCodigo(ler.next());        
                  for(int cont = 0; cont < listaNome.size(); cont++)
                    {
                       gravarArquivo.write(listaNome.get(cont) + "||" + listaCodigoAluno.get(cont) + "\n");
...
public void cadastrarCursos(){ 
            ...
            PrintWriter gravarArquivo = new PrintWriter(arquivo);
                        ...
                        gravarArquivo.write(listaCurso.get(cont) + "||" + listaCodigoCurso.get(cont) + "\n");
                        System.out.println("\nOs arquivos foram gravados com sucesso\n");
                          } 
                        gravarArquivo.close();
                    }catch(Exception erro)
    ...
    String nomeProcurado;
            ...
            PrintWriter gravarArquivo = new PrintWriter(arquivo);
                    ...
                    for(int cont = 0; cont< listaCodigoAluno.size(); cont++)
                    {
                        ...
                        {
                            System.out.println("\n O nome do Aluno e: " + listaNome.get(cont));      
                    ...
                    for(int cont1 = 0; cont1 < listaCodigoCurso.size(); cont1++)
                    {
                        ...
                        {
                             gravarArquivo.write("Nome:"+listaNome.get(cont1) + "-" + "Codigo:"+listaCodigoAluno.get(cont1) +"-" +"Curso:"+ listaCurso.get(cont1));
                             System.out.println("\n--------------------------------------\n");
